...
3. Usa nombres de actividad para describir los nombres de las actividades en la base de datos. 4. 4. Coloca etiquetas apropiadas en la base de datos con nombres de variables que las describan.
